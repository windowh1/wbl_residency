"""
Auto-generated MCP tool wrapper for list_processes
...
async def list_processes(params: Dict[str, Any]) -> str:
    """
    Auto-generated function calling MCP tool 'list_processes' on server 'desktop-commander'.
    """
