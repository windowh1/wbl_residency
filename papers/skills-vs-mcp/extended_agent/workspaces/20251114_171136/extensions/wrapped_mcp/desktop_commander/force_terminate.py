"""
Auto-generated MCP tool wrapper for force_terminate
...
async def force_terminate(params: Dict[str, Any]) -> str:
    """
    Auto-generated function calling MCP tool 'force_terminate' on server 'desktop-commander'.
    """
